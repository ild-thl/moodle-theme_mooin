...
$THEME->pageinitcallback = 'theme_mooin4_page_init';
...
// Custom colors are now handled via page_init callback (inline CSS) to avoid SCSS caching issues.
// The SCSS function is simplified - no custom colors are added here anymore.

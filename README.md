...
[![Moodle Plugin CI](https://github.com/moodle-an-hochschulen/moodle-theme_mooin4/workflows/Moodle%20Plugin%20CI/badge.svg?branch=main)](https://github.com/moodle-an-hochschulen/moodle-theme_mooin4/actions?query=workflow%3A%22Moodle+Plugin+CI%22+branch%3Amain)
...
If you want to run your grandchild theme with a different name than theme_mooin4, for example theme_boost_union_foo, you have to take some actions:

* In the whole codebase of Boost Union Child below /theme/mooin4,
  * search all occurrences of 'mooin4' and replace them with 'boost_union_foo'
  * search all occurrences of 'Boost Union Child' and replace them with 'Boost Union Foo'
* In the language pack directory /theme/mooin4/lang,
  * rename the language pack file from en/theme_boost_union.php to en/theme_boost_foo.php
* In the tests directory /theme/mooin4/tests/behat,
  * rename the Behat step definition files from behat_theme_mooin4_behat_\*.php to behat_theme_boost_union_foo_behat_\*.php
...
* In the version file /theme/mooin4/version.php,
...
As an orientation how all these settings should look like, you can compare /theme/mooin4/version.php with /theme/boost_union/version.php, of course.
...
In the [extension-setting-scss-variable](https://github.com/moodle-an-hochschulen/moodle-theme_mooin4/tree/extension-setting-scss-variable) branch, we prepared some example code which shows you how allow the admin to configure a SCSS variable with an admin setting and without fiddling with SCSS.
...
In the [extension-modify-mustache-template](https://github.com/moodle-an-hochschulen/moodle-theme_mooin4/tree/extension-modify-mustache-template) branch, we prepared some example code which shows you how to modify a mustache template from Moodle core in Boost Union Child.
...
https://github.com/moodle-an-hochschulen/moodle-theme_mooin4
...
https://github.com/moodle-an-hochschulen/moodle-theme_mooin4/issues
...
https://github.com/moodle-an-hochschulen/moodle-theme_mooin4/pulls
